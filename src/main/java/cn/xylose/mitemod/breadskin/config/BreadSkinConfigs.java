...
public class BreadSkinConfigs extends SimpleConfigs {
    ...
    public static final ConfigInteger upBarOffset = new ConfigInteger("脂肪营养条横向位置偏移", 0, -768, 768);
    ...
    static {
        ...
        NutritionBar = List.of(DrawNutritionBar, DrawEssentialFatsNutritionBar, NutritionBarMode, NutritionInfoMode, SecondaryDecrement, LeftBarOffset, RightBarOffset, upBarOffset,  BarYOffset, NutritionLimit);
