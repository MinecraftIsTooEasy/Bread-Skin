...
public class BreadSkinConfigs extends SimpleConfigs {
    ...
    public static final ConfigInteger LeftBarXOffset = new ConfigInteger("左侧营养条横向位置偏移", 0, -256, 256);
    public static final ConfigInteger RightBarXOffset = new ConfigInteger("右侧营养条横向位置偏移", 0, -256, 256);
    ...
    static {
        ...
        NutritionBar = List.of(
                DrawNutritionBar,
                DrawInsulinResistanceBar,
                DrawEssentialFatsNutritionBar,
                NutritionBarMode,
                NutritionInfoMode,
                SecondaryDecrement,
                LeftBarXOffset,
